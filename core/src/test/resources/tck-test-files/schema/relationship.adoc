...
type Movie {
  actors(options: ActorOptions): [Actor]! @relation(direction : IN, from : "from", name : "ACTED_IN", to : "to")
  id: ID
}

type Mutation {
  createActor(input: ActorCreateInput): Actor!
